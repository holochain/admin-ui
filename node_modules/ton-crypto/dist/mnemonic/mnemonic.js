...
async function mnemonicNew(wordsCount = 24, password) {
    ...
    while (true) {
        ...
        mnemonicArray = [];
        const rnd = await (0, getSecureRandom_1.getSecureRandomWords)(wordsCount);
        for (let i = 0; i < wordsCount; i++) {
            mnemonicArray.push(wordlist_1.wordlist[rnd[i] & 2047]); // We loose 5 out of 16 bits of entropy here, good enough
        }
