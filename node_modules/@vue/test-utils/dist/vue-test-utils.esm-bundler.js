    ...
    transformVNodeArgs(function (args, instance) {
        ...
        if (isComponent(type) || isFunctionalComponent(type)) {
            ...
            if (stub === true || shallow) {
                ...
                var newStub = createStub({ name: name_1, propsDeclaration: propsDeclaration, props: props });
                stubs[name_1] = newStub;
...
function mount(originalComponent, options) {
    ...
    if (global === null || global === void 0 ? void 0 : global.stubs) {
        for (var _o = 0, _p = Object.entries(global.stubs); _o < _p.length; _o++) {
            ...
            if (stub === true) {
                var stubbed = createStub({ name: name_1, props: {} });
                // default stub.
