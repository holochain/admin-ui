...
const block4 = (context, tags, suffix) => html`<${scopeTag("ui5-button", tags, suffix)} icon="decline" design="Transparent" class="ui5-message-strip-close-button" title="${ifDefined(context._closeButtonText)}" @click=${context._closeClick}></${scopeTag("ui5-button", tags, suffix)}>`;
